...
namespace EFTTool
{
    public partial class Form1 : Form
    {
        ...
        private string[] maps = new string[] {"Customs","Factory", "Interchange", "Labs - Basement", "Labs - 1st Floor", "Labs - 2nd Floor", "Reserve", "Shoreline", "Woods"};
        private Image[] mapImages = new Image[] { Resource1.CustomsMap, Resource1.FactoryMap,Resource1.InterchangeMap, Resource1.LabsBasementMap, Resource1.LabsFirstFloorMap, Resource1.LabsSecondFloorMap,Resource1.ReserveMap,
            Resource1.ShorelineMap, Resource1.WoodsMap };
        private string[] ammo = new string[] {".366 TKM","12.7x108mm","12.7x55mm STs-130","12x70mm","20x70mm","4.6x30mm HK","5.45x39mm","5.56x45mm NATO","5.7x28mm FN","7.62x25mm Tokarev","7.62x39mm","7.62x51mm NATO","7.62x54mmR",
            "9x18mm Makarov","9x19mm Parabellum","9x21mm Gyurza","9x39mm"};
